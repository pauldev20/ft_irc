...
/*   Updated: 2023/06/11 07:30:55 by pgeeser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @param oper oper is a pointer to a Client object that represents the operator being removed from the
 * Channel's list of operators.
 * 
 * @return nothing (void).
 */
 ...
 * 
 * @param client The "client" parameter is a pointer to an object of the "Client" class, which
 * represents a user connected to the IRC server. The "isOperator" function is a member function of the
 * "Channel" class, and it checks whether the given client is an operator (i.e. has
 * 
 * @return A boolean value indicating whether the given client is an operator in the channel or not.
 */
...
/**
 * This function returns a reference to a vector of pointers to Client objects representing the
 * operators of a channel.
 * 
 * @return A reference to a `std::vector` of pointers to `Client` objects, which represents the list of
 * operators for the `Channel` object.
 */
 ...
 * 
 * @param password The parameter `password` is a constant reference to a `std::string` object. It is
 * used to set the password of a `Channel` object.
 */
 ...
 * 
 * @param userLimit userLimit is an integer parameter that represents the maximum number of users
 * allowed in a channel. This function sets the user limit of the channel to the specified value.
 */
 ...
 * 
 * @param inviteOnly A boolean variable that indicates whether the channel is invite-only or not. If it
 * is set to true, only users who have been invited by a channel operator can join the channel. If it
 * is set to false, anyone can join the channel without an invitation. The function sets the value of
 * the invite
 */
...
/**
 * The function returns a boolean value indicating whether the channel is invite-only or not.
 * 
 * @return The function `isInviteOnly` is returning a boolean value that indicates whether the channel
 * is invite-only or not. The value returned is the value of the `inviteOnly` member variable of the
 * `Channel` class.
 */
 ...
 * 
 * @return The function `getUserLimit` is returning the value of the `userLimit` member variable of the
 * `Channel` class. The return type of the function is `size_t`, which is an unsigned integer type used
...
/**
 * This function adds a client to a vector of invited clients for a channel, if they are not already in
 * the vector.
 * 
 * @param client A pointer to a Client object that is being added to the vector of invited clients in a
 * Channel object.
 * 
 * @return If the client is already in the list of invited clients, the function returns without doing
 * anything. If the client is not in the list, it is added to the list of invited clients. No value is
 * explicitly returned by the function.
 */
 ...
 * 
 * @param client A pointer to a Client object that needs to be removed from all the vectors (clients,
 * invited, and operators) in the Channel object.
 */
...
/**
 * The function returns a reference to a vector of pointers to Client objects stored in a Channel
 * object.
 * 
 * @return A reference to a vector of pointers to Client objects, which is a member variable of the
 * Channel class.
 */
...
/**
 * The function checks if a given client is present in a channel by iterating through a vector of
 * clients.
 * 
 * @param client The parameter "client" is a pointer to an object of the class "Client".
 * 
 * @return This function is checking if a given client is present in the channel's list of clients and
 * returns a boolean value of true if the client is found, and false otherwise.
 */
...
/**
 * This function checks if a given channel name is valid by verifying if it starts with '#' or '&'.
 * 
 * @param channel_name The parameter `channel_name` is a constant reference to a string, which
 * represents the name of a channel.
 * 
 * @return A boolean value is being returned. It will be true if the first character of the input
 * string is '#' or '&', and false otherwise.
 */
...
/**
 * The function returns a boolean value indicating whether the channel has a topic restriction or not.
 * 
 * @return A boolean value indicating whether the channel has a topic restriction or not.
 */
 ...
 * 
 * @param set The "set" parameter is a boolean value that determines whether the topic restriction
 * should be set or not. If "set" is true, it means that the topic restriction is enabled, and if it is
 * false, it means that the topic restriction is disabled.
 */
