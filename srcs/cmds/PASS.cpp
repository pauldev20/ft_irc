...
/*   Updated: 2023/06/23 18:55:59 by pgeeser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * This function checks if a client's password matches the server's password
 * and sets the client as authenticated if it does.
 * 
 * @param message The message received from the client, which includes the PASS
 ...
 * PASS command.
 * 
 * @return nothing (void). It uses the "return;" statement to exit the function
