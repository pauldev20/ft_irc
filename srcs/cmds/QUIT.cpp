...
/*   Updated: 2023/06/23 18:58:00 by pgeeser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * The function handles a client quitting from the server and sends a
 * quit message to all channels the client was in.
 * 
 * @param message The message received from the client that triggered
 * the QUIT command.
 * @param server A pointer to the Server object that the QUIT command
 * is being executed on.
 * @param client The client who sent the QUIT command and will be
