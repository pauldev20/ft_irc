...
# ----------------------------------- CMDs ----------------------------------- #
SRCFILES	+= cmds/Command.cpp cmds/Replies.cpp cmds/CAP.cpp cmds/PASS.cpp cmds/KICK.cpp cmds/NICK.cpp cmds/USER.cpp cmds/PING.cpp cmds/QUIT.cpp cmds/PRIVMSG.cpp cmds/JOIN.cpp cmds/PART.cpp
